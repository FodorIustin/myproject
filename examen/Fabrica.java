 ...
 public class Fabrica {
    ...
    public void afisareAngajatiActivi() {
        ...
        for (Angajat angajat : angajati) {
            angajat.afisareSalariu(1000.0); 
            System.out.println("- Nume complet și funcție " + angajat.getNumeCompletSiFunctie());
        }
    }
        ...
        for (Act act : acte) {
            if (act instanceof Oferta) {
                ...
                System.out.println("- Tip: FluturasSalar, ID: " + act.getId() + ", Angajat: " +
                        ((FluturasSalar) act).getAngajat().getNumeCompletSiFunctie());
            }
        }
    }
}
